...
export default function Purchase({ close }) {
	...
	return (
		<div className="w-full">
			<h2 className="hidden lg:block">Subscriptions</h2>
			<p className="pt-2">
				Explore our Subscription options and get pro access and full
				functionality
			</p>
			<form
			...
			>
				<div className="w-full py-[15px] grid grid-cols-1 xl:grid-cols-3 gap-5">
